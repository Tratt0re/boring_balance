  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'breakdown',
        loadComponent: () =>
          import('./pages/breakdown-page/breakdown-page').then((module) => module.BreakdownPage),
      },
      {
        path: 'compare',
        loadComponent: () =>
          import('./pages/compare-page/compare-page').then((module) => module.ComparePage),
      },
      {
        path: 'accounts',
        loadComponent: () =>
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./pages/recurring-events-page/recurring-events-page').then(
